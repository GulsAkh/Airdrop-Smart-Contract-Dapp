const contractTokenAddress = '0x2E035e081b637C00dE9fAE620662bb84a8653e96';
...
const contractAirdropAddress = '0x70482833572D458EB7cC0EBC14Cb06dA5B5E7Ff1';
...
provider.send("eth_requestAccounts", []).then(() => {
    provider.listAccounts().then( (accounts) => {
        ...
        contractToken = new ethers.Contract( //это путь к оригинальному контракту, напрямую взаимод с контрактом в блокчейне
            contractTokenAddress,
            contractTokenABI,
            signer
        )
        contractAirdrop = new ethers.Contract( //это путь к оригинальному контракту, напрямую взаимод с контрактом в блокчейне
...
async function airdropTokensWithTransfer(){
    ...
    await contractAirdrop.airdropTokensWithTransfer(inputElements);
}